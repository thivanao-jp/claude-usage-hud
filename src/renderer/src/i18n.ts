...
const en = {
  ...
  labelCodexCredits: 'Extra Credits',
  descCodexCredits:  'Purchased credits consumed once the plan quota runs out',
  creditsBand:       '{0}-{1} credit band',
  creditsBandTop:    'Above {0} credits',
  ...
  codexCredits:            'Codex extra credits',
  codexCreditGauge:        'Codex — credit gauge thresholds',
  codexCreditGaugeHint:    'Codex only reports a balance, so the bar splits into three bands. Like the Claude bars, it fills to the right and the percentage rises as you spend, turning from blue to green to yellow to red.',
  codexCreditHigh:         'Comfortable (above this: empty bar)',
  codexCreditMid:          'Getting low',
  codexCreditLow:          'Critical',
  betaEnabled:             'Enable',
  betaLoginBtn:            'Login',
...
const ja = {
  ...
  labelCodexCredits: '追加クレジット',
  descCodexCredits:  'プランの枠を使い切った後に消費される購入済みクレジット',
  creditsBand:       '{0}〜{1} クレジットの段',
  creditsBandTop:    '{0} クレジット超',
  creditsRemaining:  '残高',
  ...
  codexCredits:            'Codex 追加クレジット',
  codexCreditGauge:        'Codex — 追加クレジットの目安上限',
  codexCreditGaugeHint:    'Codexは残高しか返さないため、閾値で3つの段に区切ってバーを塗ります。Claudeのバーと同じく使うほど右に伸びて%が上がり、青→緑→黄→赤と変化します。',
  codexCreditHigh:         '余裕（これを超えたら空表示）',
  codexCreditMid:          '少なめ',
  codexCreditLow:          '危険',
  betaEnabled:             '有効にする',
  betaLoginBtn:            'ログイン',
