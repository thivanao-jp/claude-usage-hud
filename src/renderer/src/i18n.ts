...
const en = {
  ...
  creditsGaugeMax:   'Gauge max {0} credits',
  creditsGaugeAbove: 'Above {0} credits',
  ...
  codexCreditGaugeHint:    'Codex only reports a balance, so the bar uses the band the balance falls into as a stand-in denominator. Lower bands turn redder.',
  codexCreditHigh:         'Comfortable (above this: full bar)',
...
const ja = {
  ...
  creditsGaugeMax:   '目安上限 {0} クレジット',
  creditsGaugeAbove: '{0} クレジット超',
  creditsRemaining:  '残高',
  ...
  codexCreditGaugeHint:    'Codexは残高しか返さないため分母がありません。残高が入る段の上限を仮の分母にしてバーを塗り、下の段ほど赤くなります。',
  codexCreditHigh:         '余裕（これを超えたら満タン表示）',
  codexCreditMid:          '少なめ',
  codexCreditLow:          '危険',
  betaEnabled:             '有効にする',
  betaLoginBtn:            'ログイン',
