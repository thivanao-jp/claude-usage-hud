...
const en = {
  ...
  codexCreditGauge:        'Codex — credit gauge max',
  codexCreditGaugeHint:    'Codex only reports a balance, so this value stands in as the denominator. Like the Claude bars, the bar fills to the right and the percentage rises as the balance drops, turning from blue to green to yellow to red.',
  betaEnabled:             'Enable',
  betaLoginBtn:            'Login',
...
const ja = {
  ...
  codexCreditGaugeHint:    'Codexは残高しか返さないため、この値を仮の分母にします。Claudeのバーと同じく残高が減るほど右に伸びて%が上がり、青→緑→黄→赤と変化します。',
  betaEnabled:             '有効にする',
  betaLoginBtn:            'ログイン',
  betaLoggedIn:            'ログイン済み',
