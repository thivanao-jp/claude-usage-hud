...
const en = {
  ...
  betaGeminiLabel:         'Google Gemini',
  betaGeminiDesc:          'Daily request quota (requires Gemini CLI login via `gemini` command)',
  betaEnabled:             'Enable',
  betaLoginBtn:            'Login',
...
const ja = {
  ...
  betaGeminiLabel:         'Google Gemini',
  betaGeminiDesc:          '日次リクエストクォータ (Gemini CLI で `gemini` を実行しログインが必要)',
  betaEnabled:             '有効にする',
  betaLoginBtn:            'ログイン',
  betaLoggedIn:            'ログイン済み',
