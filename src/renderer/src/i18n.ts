...
const en = {
  ...
  clickThroughBars:    'Click-through outside title bar',
  opacityLabel:        'Opacity (100% = opaque): {0}%',
  ...
  betaCodexDesc:           'Current Codex rate limits (requires the official Codex CLI login)',
  codexPrimary:            'Codex primary window',
  codexSecondary:          'Codex secondary window',
  betaEnabled:             'Enable',
  betaLoginBtn:            'Login',
...
const ja = {
  ...
  alwaysOnTop:         '常に最前面',
  clickThroughBars:    'タイトルバー部分以外をクリックスルー',
  opacityLabel:        '不透明度 (100% = 透過なし): {0}%',
  ...
  betaHint:                '試験的機能: GitHub Copilotの使用量を取得します。CLI由来の連携のため、予告なく変更される場合があります。',
  betaCopilotLabel:        'GitHub Copilot',
  betaCopilotDesc:         '月間プレミアムリクエスト数リミット (gh CLI ログインが必要)',
  betaCodexLabel:          'OpenAI Codex',
  betaCodexDesc:           '現在のCodex利用枠（公式Codex CLIへのログインが必要）',
  codexPrimary:            'Codex プライマリ枠',
  codexSecondary:          'Codex セカンダリ枠',
  betaEnabled:             '有効にする',
  betaLoginBtn:            'ログイン',
  betaLoggedIn:            'ログイン済み',
