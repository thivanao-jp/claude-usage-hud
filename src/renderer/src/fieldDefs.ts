...
export const WEEKLY_FIELD_DEFS: WeeklyFieldDef[] = [
  ...
  },
  {
    key: 'iguana_necktie',
    shortLabel: 'Igu',
    labelEn: 'Iguana Necktie',
    labelJa: 'Iguana Necktie',
    descEn: 'Iguana Necktie limit (plan-specific)',
    descJa: 'Iguana Necktie 制限（プラン別）',
    alertLabelEn: 'Iguana Necktie',
    alertLabelJa: 'Iguana Necktie',
    showLabelEn: 'Iguana Necktie',
    showLabelJa: 'Iguana Necktie',
    color: '#5cb87a',
    periodMs: 7 * DAY,
  },
  {
    key: 'omelette_promotional',
    shortLabel: 'OPr',
    labelEn: 'Omelette (Promo)',
    labelJa: 'Omelette (プロモ)',
    descEn: 'Promotional omelette limit',
    descJa: 'プロモーション Omelette 制限',
    alertLabelEn: 'Omelette Promo',
    alertLabelJa: 'Omelette プロモ',
    showLabelEn: 'Omelette Promotional',
    showLabelJa: 'Omelette プロモーション',
    color: '#d4a050',
    periodMs: 7 * DAY,
  },
]
